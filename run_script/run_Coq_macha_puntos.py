...
outname='Part_Coq_macha_puntos'
#particulas_total=10000
dias_deriva = 25 # PLD macha
num_part = 10   # 7200 =1 per hour  for 1 month
#mindep = -20
#maxdep = -40
...
np.savetxt('Part_Coq_macha_puntos.txt', all, fmt='%s %.4f %.4f %s %.4f %.4f %i')
print(o)
