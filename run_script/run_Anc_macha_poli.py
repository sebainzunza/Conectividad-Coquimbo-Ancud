...
outname='Part_Anc_macha_poli'
#particulas_total=10000
dias_deriva = 25 # PLD macha Ancud
num_part = 80   # 7200 =1 per hour  for 1 month
#mindep = -20
#maxdep = -40
...
np.savetxt('Part_Anc_macha_poli.txt', all, fmt='%s %.4f %.4f %s %.4f %.4f %i')
print(o)
